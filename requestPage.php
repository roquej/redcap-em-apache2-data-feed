...
/**
 * exit function to end data feed process
 * @param $message
 * @return void
 */
function exit_process($message) {
...
if($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    REDCap::logEvent("Started APACHE II Data Feed process.");
    $success_exit = "The APACHE II Data Feed successfully retrieved and saved new data to your REDCap project.";
    $failure_exit = "ERROR- APACHE II Data Feed failed to retrieve and save data.";
    $no_new_data = "The APACHE II Data Feed successfully completed but there was no retrievable data or changes to save.";
    ...
    if($flowlab_save_response["item_count"] === 0 && $aao2_save_response["item_count"] === 0) {
        exit_process($no_new_data);
    }
    exit_process($success_exit);
}
